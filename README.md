...
- Autonomous strategy loop: trend intake -> idea scoring -> generation -> moderation/safety review -> schedule -> publish -> analytics -> strategy update.
- AI moderation with rules, reputation scoring, and optional LLM classification.
- Content queue, anti-duplicate hashing, timezone-aware scheduler, Telegram rate throttling.
- Giveaway/referral/activity primitives.
